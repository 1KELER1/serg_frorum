    ...
    <div style={{ marginTop: 100 }}>
      ...
      <Grid container spacing={3} >
        ...
        <Grid item xs={12} md={6} >
          ...
          <Typography variant="h5" >Последние обсуждения</Typography>
          <ThreadForm />
          </div>
          <Item >    
            <InfiniteScroll
            ...
            next={fetchData}
            hasMore={hasMore}
            loader={<h4 style={{ textAlign: 'center', marginTop: 20}}>Загрузка...</h4>}
            endMessage={
                <p style={{ textAlign: 'center', marginTop: 20}}>
                <span>Вы просмотрели все темы.</span>
                </p>
            }>
        ...
        <Grid item md = {4}
          ...
          <div className='d-flex mb-3'> 
            <Typography variant="h5" ><BookmarksIcon sx={{marginRight: 2}}/>Популярные темы </Typography>
          </div>
